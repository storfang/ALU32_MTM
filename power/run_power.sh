...
innovus -stylus -abort_on_error -no_gui -files ./tcl/run_power.tcl -log innovus_mtm -overwrite
...
# innovus -stylus -abort_on_error -files ./tcl/run_power.tcl -log innovus_mtm -overwrite
